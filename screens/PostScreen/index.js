            ...
            >
              <Row>
                <Col>
                  ...
                  >
                    Choosing The Right University – Study Abroad Counseling
                  </h1>
                </Col>
              </Row>
              <Row>
              ...
              <Row>
                <Col>
                  <p>
                    College life is an experience whose memories last a
                    lifetime, especially because college is perhaps the only
                    time between youth and adult life. You can live a pseudo
                    suspended life, with as much time for play, as for
                    extracurricular activities. As one steps into the
                    professional sphere, an adult rues the lack of work-life
                    balance, making college life even more memorable.
                  </p>
                  <p>
                    Everyone has some memories of school: were you the
                    wallflower, the cheerleader, the class brute, or at the
                    receiving end of sniggers from the backbench, all because
                    you did not do your homework? At school, we develop
                    personalities, in relation to others, likes and dislikes,
                    where there’s a lesser chance of actually having a voice in
                    choosing the institution. As pre-adults, the luxury of
                    choice means you have the freedom to choose the environment
                    that will best encourage your growth as a student,
                    individual, and, eventually, professional.
                  </p>
                </Col>
              </Row>
              <Row>
