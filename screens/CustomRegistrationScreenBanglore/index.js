            ...
            <Row>
              <Col className={styles.eventBanner} style={{
                ...
                <Image
                  ...
                  layout="responsive"
                  quality={100}
                  src="https://collegepass-event-banners.s3.ap-south-1.amazonaws.com/CollegePass_page_headers_05_feb_pe.png"
                  alt="Event Banner"
                />
              </Col>
            </Row>
            ...
            <Row>
              <Col className={styles.eventBanner} style={{
                ...
                <Image
                  ...
                  layout="responsive"
                  quality={100}
                  src="https://collegepass-event-banners.s3.ap-south-1.amazonaws.com/BLR_event-app_pe_05.png"
                  alt="Event Banner"
                />
              </Col>
            </Row>
              ...
              <Row>
                <Col>
                  <div>
                    ...
                    <p>Join us as we host "The Ivy League Admissions Workshop" on Sunday, Feb 05.</p>
                    <p>Venue: <span style={{
                      color: 'rgb(230, 168, 81)'
                    }}> WelcomHotel by ITC, Richmond Road, Bangalore</span><br/>
                    Day & Date: <span style={{
                      color: 'rgb(230, 168, 81)'
                    }}>Sunday, Feb 05</span><br/>
                    Timing: <span style={{
                      color: 'rgb(230, 168, 81)'
