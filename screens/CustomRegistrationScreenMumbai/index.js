...
const CustomRegistrationScreen = ({ eventID }) => {
            ...
            <Row>
              <Col className={styles.eventBanner} style={{
                ...
                <Image
                  ...
                  layout="responsive"
                  quality={100}
                  src="https://collegepass-event-banners.s3.ap-south-1.amazonaws.com/CollegePass_page_headers_18_feb_pe.png"
                  alt="Event Banner"
                />
              </Col>
            </Row>
            ...
            <Row>
              <Col className={styles.eventBanner} style={{
                ...
                <Image
                  ...
                  layout="responsive"
                  quality={100}
                  src="https://collegepass-event-banners.s3.ap-south-1.amazonaws.com/mum_event_app_18_feb_pe.png"
                  alt="Event Banner"
                />
              </Col>
            </Row>
              ...
              <Row>
                <Col>
                  <div>
                    ...
                    <p>Join us as we host "The Ivy League Admissions Workshop" on Saturday, Feb 18.</p>
                    <p>Venue: <span style={{
                      color: 'rgb(230, 168, 81)'
                    }}>The Trident, BKC, Mumbai</span><br/>
                      Day & Date: <span style={{
                      color: 'rgb(230, 168, 81)'
                    }}>Saturday, Feb 18</span><br/>
                      Timing: <span style={{
                      color: 'rgb(230, 168, 81)'
                    }}>12.30pm onwards</span></p>
                    <p><span style={{
                      color: 'rgb(230, 168, 81)'
...
export default CustomRegistrationScreen