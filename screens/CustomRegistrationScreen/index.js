            ...
            <Row>
              <Col className={styles.eventBanner} style={{
                ...
                <Image
                  ...
                  layout="responsive"
                  quality={100}
                  src="https://collegepass-event-banners.s3.ap-south-1.amazonaws.com/CollegePass_page_headers_11_pe.png"
                  alt="Event Banner"
                />
              </Col>
            </Row>
            ...
            <Row>
              <Col className={styles.eventBanner} style={{
                ...
                <Image
                  ...
                  layout="responsive"
                  quality={100}
                  src="https://collegepass-event-banners.s3.ap-south-1.amazonaws.com/worli_event-app.png"
                  alt="Event Banner"
                />
              </Col>
            </Row>
              ...
              <Row>
                <Col>
                  <div>
                    ...
                    <p>Join us as we host "The Ivy League Admissions Workshop" on Saturday, Feb 11.</p>
                    <p>Venue: <span style={{
                      color: 'rgb(230, 168, 81)'
                    }}>The St. Regis Hotel, Worli, Mumbai</span><br/>
                      Day & Date: <span style={{
                      color: 'rgb(230, 168, 81)'
                    }}>Saturday, Feb 11</span><br/>
                      Timing: <span style={{
                      color: 'rgb(230, 168, 81)'
                    }}>11:30 am onwards</span></p>
                    <p><span style={{
                      color: 'rgb(230, 168, 81)'
