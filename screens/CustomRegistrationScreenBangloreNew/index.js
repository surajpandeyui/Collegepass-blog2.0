...
const CustomRegistrationScreenGurgaon = ({ eventID }) => {
            ...
            <Row>
              <Col className={styles.eventBanner} style={{
                ...
                <Image
                  ...
                  layout="responsive"
                  quality={100}
                  src="https://collegepass-event-banners.s3.ap-south-1.amazonaws.com/CollegePass_page_headers_12_feb_pe.png"
                  alt="Event Banner"
                />
              </Col>
            </Row>
            ...
            <Row>
              <Col className={styles.eventBanner} style={{
                ...
                <Image
                  ...
                  layout="responsive"
                  quality={100}
                  src="https://collegepass-event-banners.s3.ap-south-1.amazonaws.com/BLR_event-app_12_feb_pe.png"
                  alt="Event Banner"
                />
              </Col>
            </Row>
              ...
              <Row>
                <Col>
                  <div>
                    ...
                    <p>Join us as we host "The Ivy League Admissions Workshop" on Sunday, Feb 12.</p>
                    <p>Venue: <span style={{
                      color: 'rgb(230, 168, 81)'
                    }}> The Sheraton Grand, PSN Whitefield, Bangalore</span><br/>
                    Day & Date: <span style={{
                      color: 'rgb(230, 168, 81)'
                    }}>Sunday, Feb 12</span><br/>
                    Timing: <span style={{
                      color: 'rgb(230, 168, 81)'
                    }}>11:30 am - 12:30pm</span></p>
                    <p><span style={{
                      color: 'rgb(230, 168, 81)'
...
export default CustomRegistrationScreenGurgaon