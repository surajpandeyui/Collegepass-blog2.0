...
import IvyEssayWritingContestScreen from '../screens/IvyEssayWritingContestScreen';

export default function IvyEssayWritingContest() {
	return (
		<>
			<Head>
				<title>CollegePass - Ivy Essay Writing Contest</title>
				<title>Ivy Essay Writing Contest | CollegePass</title>
			...
			<main className="bg-black">
				<IvyEssayWritingContestScreen></IvyEssayWritingContestScreen>
			</main>
		</>
	)
}
