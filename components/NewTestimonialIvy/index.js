...
import styles from '../NewTestimonialIvy/n-testimonial-ivy.module.scss'
    ...
    let slideData = [
        {
            ...
            id: 'https://player.vimeo.com/video/721704256?autoplay=1&h=e55c434cea',
                                ...
                                <Col className={styles.AidenSection}>
                                    <Row>
                                        <Col lg={6} md={6} sm={12} xs={12}>
                                            <Row>
                                                <Col>
                                                    <h2>COLLEGEPASS STUDENTS ARE LIVING THEIR DREAM
                                                    </h2>
                                                </Col>
                                            </Row>
                                            <Row>
                                                <Col>
                                                    <h3>CollegePass Students have been admitted to The Ivy League and Top 50 Colleges globally!</h3>
                                                </Col>
                                            </Row>
                                            <Row>
                                                <Col>
                                                ...
                                                <Col className={styles.ugtestiVideoThumb}>
                                                    <Row>
                                                        <Col className={styles.ugVideoThumb}>
                                                            <Image
                                                                src="/testimonial-thumb/ug_admissions_tiles_image.jpg"
                                                                width="500"
                                                                height="300"
                                                            //className={}
                                                            />
...
export default NewTestimonialIvy
