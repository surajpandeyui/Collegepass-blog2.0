                        ...
                        <Offcanvas.Body>
                          <Nav className="justify-content-end flex-grow-1">
                            <Nav.Link
                              ...
                              href="https://collegepass.org/collegepass-plus"
                              id=""
                              style={{
                                marginRight: '2rem',
                              }}
                            ...
                            <Nav.Link
                              target="_blank"
                              rel="noopener noreferrer"
                              href="https://collegepass.org/ivy-league-undergraduate-admissions"
                              id=""
                              style={{
                                marginRight: '2rem',
                              }}
                            ...
                            <Nav.Link
                              target="_blank"
                              rel="noopener noreferrer"
                              href="https://collegepass.org/ms-admissions"
                              id=""
                              style={{
                                marginRight: '2rem',
                              }}
                            ...
                            <Nav.Link
                              target="_blank"
                              rel="noopener noreferrer"
                              href="https://collegepass.org/sat-tutoring"
                              id=""
                              style={{
                                marginRight: '2rem',
                              }}
                            ...
                            <Nav.Link
                              target="_blank"
                              rel="noopener noreferrer"
                              href="https://collegepass.org/ib-tutoring"
                              id=""
                              style={{
                                marginRight: '2rem',
                              }}
