                                    ...
                                    <Navbar.Offcanvas placement="end">
                                        ...
                                        <Offcanvas.Body>
                                            <Nav className="justify-content-end flex-grow-1">
                                              <Nav.Link href="" id="" className="welcome-drop-new">
                                               WELCOME, {auth.userDetails.FIRSTNAME}
                                              </Nav.Link>
                                            {isPremiumPlus && (<Nav.Link href="" id="ug-menu-adm-adv" onClick={() => {
                                                      window.open(
                                                        `http://advisor.collegepass.org/landing/${localStorage.token}`
                                                      )
                                                    }}
                                                  >
                                                    My Profile Builder</Nav.Link>
                                                    ) 
                                                    // : (
                                                    //   null
                                    ...
                                    <Nav className="ms-auto">
                                        <Nav.Link href="/collegepass-plus" id="ug-menu-adm-adv" style={{
                                          ...
                                          {isPremiumPlus ? (<Nav.Link href="" id="ug-menu-adm-adv" onClick={() => {
                                            ...
                                            <Nav.Link href="/livestream" id="ug-menu-adm-adv">My Live Streams</Nav.Link>
                                            <Nav.Link href="/masterclass" id="ug-menu-adm-adv">My Masterclasses</Nav.Link>
                                            {allowAdvisingPanel?( <Nav.Link href="/liveclass" id="ug-menu-adm-adv">My Classes</Nav.Link>):(null)}
                                           
                                            <Nav.Link href="/account" id="ug-menu-adm-adv">My Account</Nav.Link>
                                            <Nav.Link id="ug-menu-adm-adv" onClick={onLogoutHandler}>Sign out</Nav.Link>
                                          </span>
                                          ...
                                          <NavDropdown title="" className="custom-dropdown-for-profile-icon" id="icon-dropdone-af-l" renderMenuOnMount={true}>
                                              ...
                                              /> <span style={{
                                                ...
                                                top: '6%',
                                                marginLeft: '2%'
                                              }}>{auth.userDetails.FIRSTNAME}</span></div>
                                              </NavDropdown.Item>
                                              {isPremiumPlus ? (
                                                <NavDropdown.Item
                                                  onClick={() => {
                                              ...
                                              {allowAdvisingPanel ? (  <NavDropdown.Item href="/liveclass">
                                                My Classes
