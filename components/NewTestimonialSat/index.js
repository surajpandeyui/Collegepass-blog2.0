...
import styles from '../NewTestimonialSat/n-testimonial-sat.module.scss'
    ...
    let slideData = [
        {
            ...
            id: "https://player.vimeo.com/video/739933139?autoplay=1&h=390a63c60e",
            alt: "",
        },
        {
                                ...
                                <Col className={styles.AidenSection}>
                                    <Row>
                                        <Col lg={6} md={6} sm={12} xs={12}>
                                            ...
                                            <Row>
                                                <Col>
                                                    <h3>CollegePass students have consistently scored <br/>1550+ on test dates since 2018!</h3>
                                                </Col>
                                            </Row>
                                            <Row>
                                                <Col>
...
export default NewTestimonialSat
